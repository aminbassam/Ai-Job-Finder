...
export function ResumeGenerationDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[92vh] w-[min(760px,calc(100vw-1rem))] flex-col overflow-hidden border-[#1F2937] bg-[#111827] p-0 text-white sm:w-[min(820px,calc(100vw-2rem))]">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4 sm:px-6">
          <div className="space-y-5">
            <div className="rounded-xl border border-[#1F2937] bg-[#0B0F14] p-4 sm:p-5">
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className={`rounded-xl border p-4 ${legacyAiEnabled ? "border-[#1F2937] bg-[#0B0F14]" : "border-dashed border-[#1F2937] bg-[#0B0F14]/60 opacity-80"}`}>
                  <p className="text-[12px] font-semibold uppercase tracking-wide text-[#9CA3AF]">Legacy Preferences</p>
              ...
              <div className="rounded-xl border border-[#1F2937] bg-[#0B0F14] p-4 sm:p-5">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <p className="flex items-center gap-2 text-[12px] font-semibold uppercase tracking-wide text-[#4F8CFF]">
                ...
                <p className="mt-3 text-[12px] leading-relaxed text-[#D1D5DB]">
                  The generation goal and included inputs follow the <span className="font-medium text-white">Default AI Instructions</span> section in Settings, together with your selected profiles, provider, and any optional custom AI role.
                </p>
        ...
        <DialogFooter className="shrink-0 border-t border-[#1F2937] bg-[#111827] px-5 py-4 sm:px-6">
          <Button
            variant="outline"
